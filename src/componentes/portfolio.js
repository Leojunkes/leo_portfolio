    ...
    <>
      <nav id="navbarLeo" className="navbar navbar-expand-md navbar-light ">
        <div className="container-fluid">
          <a id="navText" className="navbar-brand" href="#">
            LeoJunkes
          </a>
          <button
          ...
          <div className="collapse navbar-collapse" id="leoPortfolio">
            <ul className="navbar-nav mr-auto">
              <li className="nav-item">
                <a id="navText" className="nav-link" href="#projetosText">
                  Projetos
                </a>
              </li>
              <li className="nav-item">
                <a id="navText" className="nav-link" href="#sobremimText">
                  Sobre mim
                </a>
              </li>

              <li className="nav-item">
                <a id="navText" className="nav-link" href="#gmailText">
                  Contato
                </a>
              </li>
              <li className="nav-item">
                <a id="navText" className="nav-link" href="#sobremimText1">
                  Meu Currículo
                </a>
              </li>
            </ul>
      ...
      <div className="container-fluid" id="leoDescricao">
        <div className="col-lg-6 col-md-8 mx-auto">
          ...
          <h1 id="leoTextdescricao" className="fw-light">
            Leonardo Junkes
          </h1>
          <p id="leoTextdescricao" className="lead ">
            Estudante de Programação (React-Js e React-Native) - Motorista de
            App.
          </p>
          <p>
            <a href="#gmailText" className="btn btn-dark my-2">
              Contato
            </a>
          </p>
          <a
          ...
          <a id="icones" href="https://github.com/Leojunkes">
      ...
      <h2 id="projetosText" className="jumbotron-heading text-center">
        Projetos
      </h2>
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
          ...
          <div className="card shadow-sm">
            ...
            <div className="card-body">
              <p className="card-text">
                Site criado por mim, para Melissa, criado em React-Js.
              </p>
        ...
        <div className="col-md-4">
          <div className="card shadow-sm">
            ...
            <div className="card-body">
              <p className="card-text">
                Aprendi o conceito, e criei do meu jeito um conversor de moedas,
                criado em React-Js.
              </p>
              <div className="d-flex justify-content-between align-items-center">
                <div className="btn-group">
                  <a
                    href="http://conversorjunkes.s3-website-sa-east-1.amazonaws.com/"
                    target="_blank"
                  >
                    <button
                      type="button"
                  ...
                  <a
                    href="https://github.com/Leojunkes/conversor"
                    target="_blank"
                  >
                    <button
                      type="button"
        ...
        <div class="col-md-4">
          <div class="card shadow-sm">
            ...
            <div class="card-body">
              <p class="card-text">
                Quizz de memorização de caracteres japonês, escolha entre
                alfabeto Hiragana ou Katakana, criado em React-Native.
              </p>
      ...
      <section id="sobremimText" className="jumbotron text-center">
        <div className="container">
          <h2 id="sobreLeoText" className="jumbotron-heading">
            Sobre mim
          </h2>
          <p id="leoTextdescricao" className="lead">
      ...
      <section id="sobremimText1" className="jumbotron text-center">
        <div className="container">
          <h2 id="sobreLeoText1" className="jumbotron-heading">
            Currículo
          </h2>
      ...
      <section>
        <div id="disponivelText">
          <h3 id="disponivelLeoText" className="text-center">
            Disponível para oportunidades
          </h3>
          <a href="mailto:leojn8@gmail.com">
            <h4 id="gmailText" className="text-center">
            <i class="far fa-hand-point-right mr-2" style={{color:'#ffffff'}}></i>leojn8@gmail.com<i class="far fa-hand-point-left ml-2"style={{color:'#ffffff'}} ></i>
            </h4>
          </a>
        </div>
      </section>
